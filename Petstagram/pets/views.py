...
def pet_add_page(request):
    ...
    return render(request, 'templates/pets/pet-add-page.html', context)
...
def pet_edit_page(request, username: str, pet_slug: str):
    ...
    return render(request, 'templates/pets/pet-edit-page.html', context)
...
def pet_delete_page(request, username: str, pet_slug: str):
    ...
    return render(request, 'templates/pets/pet-delete-page.html', context)
...
def pet_details_page(request, username: str, pet_slug: str):
    ...
    return render(request, 'templates/pets/pet-details-page.html', context)
